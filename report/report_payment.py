...
class ReportAbstractPayment(models.AbstractModel):
    _name = 'camaracomercio.abstract.reporte_account_payment'
...
class ReportPayment1(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment1'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'

class ReportPayment2(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment2'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'

class ReportPayment3(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment3'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'

class ReportPayment4(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment4'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'

class ReportPayment5(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment5'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'

class ReportPayment6(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment6'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'
    
class ReportPayment7(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment7'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'
    
class ReportPayment8(models.AbstractModel):
    _name = 'report.camaracomercio.reporte_account_payment8'
    _inherit = 'camaracomercio.abstract.reporte_account_payment'